...
import { DollarSign, ShoppingCart, Package, AlertCircle } from 'lucide-vue-next';
        ...
        <template v-if="props.stats">
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold">{{ props.stats.pending_orders }}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold">{{ props.stats.active_products }}</div>
                    </CardContent>
                </Card>
            </div>
            
            <div class="relative min-h-[50vh] flex-1 rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border mt-4">
                <div class="p-6 flex items-center justify-center h-full text-muted-foreground">
