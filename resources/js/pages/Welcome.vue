    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-primary/50"
                >
                    {{ $t('Dashboard') }}
                </Link>
                <template v-else>
        ...
        >
            ...
            >
                ...
                <div
                    class="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-primary/10 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <!-- Laravel Logo -->
                    <svg
                        class="w-full max-w-none translate-y-0 text-primary opacity-100 transition-all duration-750 starting:opacity-0 motion-safe:starting:translate-y-6"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
